...
<a href="/students/{student_id}/tutor-group/{course.id}" class="block p-4 border hover:shadow-lg transition-shadow rounded {in_progress ? 'bg-white border-blue-300' : 'bg-blue-50 border-gray-200'} border border-gray-200">
